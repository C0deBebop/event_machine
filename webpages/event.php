...
<header>
  ...
  <div class="container">  
      <div id="events">
         <h4>Add events</h4>
         <form method="post" action="/event_machine/event/">
           ...
           <input type="date" name="start_date" value="2024-07-18">
           <input type="date" name="end_date" value="2024-07-18">
           <input type="text" name="start_time" placeholder="12:00 PM">
           <input type="text" name="end_time" placeholder="12:00 PM">
